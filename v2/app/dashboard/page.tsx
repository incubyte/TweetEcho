...
export default function Dashboard() {
  ...
  const initializeDatabase = async () => {
    ...
    try {
      ...
      alert(
        "Database initialized successfully! The page will now reload to load your data."
      );
      ...
      alert(
        "Failed to initialize database. Please try again or contact support."
      );
    } finally {
      ...
      {!dbInitialized && (
        <Card className="mb-8 border-orange-500">
          <CardHeader className="bg-orange-50 dark:bg-orange-950">
            ...
            <CardDescription>
              Your database tables need to be initialized before you can use all
              features.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            <p className="mb-4">
              The application needs to create database tables for storing user
              metadata and web content.
            </p>
            <Button
      ...
      {user && !dbInitialized && (
        <div className="text-center py-8">
          <p className="text-muted-foreground">
            Please initialize the database above to access profile management
            features.
          </p>
        </div>
      )}
