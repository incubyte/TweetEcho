...
export async function POST(request: NextRequest) {
  try {
    ...
    if (
      !data.writing_style ||
      !Array.isArray(data.writing_style) ||
      !data.hashtag_pattern ||
      typeof data.hashtag_pattern !== "object" ||
      !data.emoji_usage ||
      typeof data.emoji_usage !== "object" ||
      !data.sentence_and_vocab ||
      typeof data.sentence_and_vocab !== "object" ||
      !data.top_performing_tweets ||
      typeof data.top_performing_tweets !== "object" ||
      !data.engagement_trends ||
      typeof data.engagement_trends !== "object"
    ) {
